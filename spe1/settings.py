"""
Django settings for spe1 project.
...
SECRET_KEY = 'django-insecure-vgmt8+ire=qp7)vgq&fqp@^5642!m(vty8rbok#zfzul$pw5ut'
...
WSGI_APPLICATION = 'spe1.wsgi.application'
